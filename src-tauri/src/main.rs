...
fn main() {
    ...
    let app = if simple_edition {
        ...
        builder.invoke_handler(tauri::generate_handler![
            ...
            operations::list_personnel_control_history,
            ...
            operations::list_asset_catalogs,
            operations::save_asset_catalog,
            operations::delete_asset_catalog,
            operations::list_service_assets,
            operations::create_service_asset,
            operations::create_service_assets,
            operations::create_uav_complex_with_children,
            operations::set_uav_complex_children,
            operations::update_service_asset,
            operations::add_service_asset_quantity,
            operations::delete_service_asset,
            operations::list_asset_history,
