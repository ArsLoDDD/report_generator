...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    steps: ["Експортуйте дані, щоб отримати .xlsx з українськими назвами колонок у першому рядку та ключами для програми у другому.", "Файл містить особовий склад, автомобілі, екіпажі, склад екіпажів, генератори, БпЛА, зв’язок, зброю та БК, інциденти й мапи полів для кожного розділу.", "Для нового файлу використовуйте такий самий шаблон: записи починаються з третього рядка.", "Під час імпорту оберіть «Замінити базу», щоб зробити БД точно такою, як у файлі, або «Доповнити», щоб додати нові записи до наявних.", "Порожній файл-шаблон можна імпортувати у режимі заміни — результатом буде повністю порожня база."],
