...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    purpose: "Зарезервований модуль для майбутнього планування роботи екіпажів і БпАК.",
    steps: ["Відкрийте сторінку з розділу розширеного обліку особового складу.", "Форма планування й пов’язані записи будуть додані окремим етапом."],
    notes: ["Наразі сторінка навмисно не змінює дані й слугує підготовленою точкою для подальшої розробки."]
  },
  {
