...
const sections: GuideSection[] = [
  {
    ...
    steps: ["Оберіть шаблон зі списку або відкрийте DOCX-файл.", "Позначте одного чи кількох військовослужбовців.", "Вкажіть дату лише тоді, коли шаблон містить {{дата_рапорту}}.", "Переконайтеся, що швидка перевірка не показує помилок, і натисніть «Згенерувати рапорт»."],
  ...
  },
  {
    ...
    steps: ["У режимі «Конструктор змінних» оберіть об’єкт: військовослужбовець, потрібний підписант або дату рапорту.", "Оберіть поле. Для військовослужбовця вкажіть номер — за замовчуванням 1.", "За потреби додайте один відмінок, один модифікатор регістру та будь-яке сумісне форматування DOCX.", "Перевірте токен, приклад значення й речення праворуч, потім скопіюйте його до Word."],
