...
describe("PersonnelPage CRUD", () => {
  ...
  it("keeps detail actions outside the scroll area and groups assigned property", async () => {
    ...
    const details = document.querySelector<HTMLElement>(".person-details--personnel");
    expect(details).toBeInTheDocument();
    if (!details) throw new Error("Personnel details panel is missing");
    const header = details.querySelector<HTMLElement>(".entity-details__header");
    const content = details.querySelector<HTMLElement>(".entity-details__body");
    const actions = details.querySelector<HTMLElement>(".entity-details__actions");
