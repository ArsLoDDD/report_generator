...
import { AlertCircle, CalendarDays, Car, Pencil, RefreshCw, Trash2, UserPlus, Users, X } from "lucide-react";
...
export function PersonnelPage({ people, isLoading, errorMessage, onCreate, onUpdate, onDelete, onRefresh }: PersonnelPageProps) {
