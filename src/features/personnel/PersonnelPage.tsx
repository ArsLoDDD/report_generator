...
type PersonDetailTab = "Основне" | "Служба" | "Документи" | "Контакти" | "БЧС" | "Зв’язки" | "Кастомні поля";
const personDetailTabs: PersonDetailTab[] = ["Основне", "Служба", "Документи", "Контакти", "БЧС", "Зв’язки", "Кастомні поля"];
