...
export const reportGenerationService = {
  ...
  validateTemplate: (templatePath: string, personnelIds: number[], reportDate?: string, vehicleIds: number[] = []) => invoke<TemplateValidationResult>("validate_template", { templatePath, personnelIds, reportDate, vehicleIds }),
