...
export type ReportEquipment = { id: number; category: string; serviceCode?: string; name: string; fullName?: string; inventoryNumber: string; serialNumber?: string; status: string; crewName: string | null; holderName: string | null };
