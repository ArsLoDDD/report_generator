...
export function GeneratedReportsPage() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      await refresh();
      notify(pathsToDelete.length === 1 ? "Рапорт переміщено до кошика програми." : `До кошика переміщено рапортів: ${pathsToDelete.length}.`, "success");
