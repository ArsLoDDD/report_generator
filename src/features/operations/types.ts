...
export type AssetServiceCode = "zbbr" | "zu" | "gz_kb" | "siiz" | "ms" | "ets" | "ovtm" | "rs" | "sa_ppo" | "svt" | "pmm";
export type AssetCatalogField = { id: number; catalogId: number; fieldKey: string; displayName: string; fieldType: string; initialValue: string; sortOrder: number };
export type AssetCatalog = { id: number; serviceCode: AssetServiceCode; name: string; isSystem: boolean; sortOrder: number; fields: AssetCatalogField[] };
export type AssetCatalogDraft = { serviceCode: AssetServiceCode; name: string; fields: Array<Omit<AssetCatalogField, "id" | "catalogId">> };
