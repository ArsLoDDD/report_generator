...
export type PositionWorkMember = { personnelId: number; fullName: string; rank: string };
...
export type PositionWorkDraft = Omit<PositionWork, "id" | "positionName" | "members"> & { personnelIds: number[] };
...
export type FlightPlanCrewLocationAssignment = { crewId: number; stages: number[][] };
