...
export const operationsService = {
  ...
  createServiceAssets: (drafts: ServiceAssetDraft[]) => mutate<number[]>("create_service_assets", { drafts }),
  createUavComplexWithChildren: (complex: ServiceAssetDraft, existingChildIds: number[], newChildren: ServiceAssetDraft[]) => mutate<number>("create_uav_complex_with_children", { complex, existingChildIds, newChildren }),
  setUavComplexChildren: (parentId: number, childIds: number[]) => mutate<void>("set_uav_complex_children", { parentId, childIds }),
