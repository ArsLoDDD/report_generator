...
export function FlightPlanningPage(){
  ...
  const saveValid=!hasInvalidSelectedSchedule&&!hasInvalidPersonnelTransitions&&!invalidSelectedMemberState.length&&/^\d{2}\.\d{2}\.\d{4}$/u.test(date);
