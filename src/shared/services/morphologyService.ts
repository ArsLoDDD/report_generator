...
export const morphologyService = {
  ...
  declineRank(value: string, grammaticalCase: UkrainianCase) {
    const forms: Record<string, Record<UkrainianCase, string>> = { "солдат": { називний: "солдат", родовий: "солдата", давальний: "солдату", знахідний: "солдата", орудний: "солдатом", місцевий: "солдаті", кличний: "солдате" }, "старший солдат": { називний: "старший солдат", родовий: "старшого солдата", давальний: "старшому солдату", знахідний: "старшого солдата", орудний: "старшим солдатом", місцевий: "старшому солдаті", кличний: "старший солдате" }, "сержант": { називний: "сержант", родовий: "сержанта", давальний: "сержанту", знахідний: "сержанта", орудний: "сержантом", місцевий: "сержанті", кличний: "сержанте" }, "капітан": { називний: "капітан", родовий: "капітана", давальний: "капітану", знахідний: "капітана", орудний: "капітаном", місцевий: "капітані", кличний: "капітане" }, "майор": { називний: "майор", родовий: "майора", давальний: "майору", знахідний: "майора", орудний: "майором", місцевий: "майорі", кличний: "майоре" }, "лейтенант": { називний: "лейтенант", родовий: "лейтенанта", давальний: "лейтенанту", знахідний: "лейтенанта", орудний: "лейтенантом", місцевий: "лейтенанті", кличний: "лейтенанте" }, "старший лейтенант": { називний: "старший лейтенант", родовий: "старшого лейтенанта", давальний: "старшому лейтенанту", знахідний: "старшого лейтенанта", орудний: "старшим лейтенантом", місцевий: "старшому лейтенанті", кличний: "старший лейтенанте" }, "молодший сержант": { називний: "молодший сержант", родовий: "молодшого сержанта", давальний: "молодшому сержанту", знахідний: "молодшого сержанта", орудний: "молодшим сержантом", місцевий: "молодшому сержанті", кличний: "молодший сержанте" }, "старший сержант": { називний: "старший сержант", родовий: "старшого сержанта", давальний: "старшому сержанту", знахідний: "старшого сержанта", орудний: "старшим сержантом", місцевий: "старшому сержанті", кличний: "старший сержанте" }, "підполковник": { називний: "підполковник", родовий: "підполковника", давальний: "підполковнику", знахідний: "підполковника", орудний: "підполковником", місцевий: "підполковнику", кличний: "підполковнику" }, "полковник": { називний: "полковник", родовий: "полковника", давальний: "полковнику", знахідний: "полковника", орудний: "полковником", місцевий: "полковнику", кличний: "полковнику" } };
  ...
  declinePosition(value: string, grammaticalCase: UkrainianCase) {
    ...
    const known: Record<string, Partial<Record<UkrainianCase, string>>> = {
      ...
      механік: { родовий: "механіка", давальний: "механіку", знахідний: "механіка", орудний: "механіком", місцевий: "механіку", кличний: "механіку" }
    };
