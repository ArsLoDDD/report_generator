...
export type ExcelImportResult = { imported: number; warnings: string[] };
...
export const personnelService = {
  ...
  importExcel: (path: string, mode: "append" | "replace") => invoke<ExcelImportResult>("import_personnel_xlsx", { path, mode }),
