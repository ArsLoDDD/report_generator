...
| 4 | Аналізатор рапортів | split-view із DOCX preview | Створити шаблон | пропозиції, ручні заміни, поля автозаповнення |
| 5 | Згенеровані рапорти | наявний layout, color-only | Відкрити | bulk delete |
| 6 | Поля автозаповнення (контекстне вікно, не сторінка) | пошук + джерела + модифікатори | Застосувати / скопіювати | Шаблони, Аналізатор |
